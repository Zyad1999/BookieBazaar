...
public class EditBookController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        BookDto bookDto=BookServicesImpl.getBookServices().findBook(Integer.parseInt(id), entityManager);
        request.setAttribute("currentBook", bookDto);
        request.getRequestDispatcher("admin_book_detail.jsp").include(request, response);
