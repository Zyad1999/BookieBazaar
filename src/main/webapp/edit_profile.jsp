              ...
              <div class="menu_side">
                <div id="navbar_menu">
                  <ul class="first-ul">
                    ...
                    <li><a href="cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a> Cart</li>
                  </ul>
                </div>
                  ...
                  <div class="form_section">
                    <form class="form_contant" action="editeProfile" METHOD="post">
                      <fieldset class="row">
                        ...
                        <div class="field col-lg-3 col-md-3 col-sm-3 col-xs-3">
                          <select title="Countries" class="field_custom" name="country"
                            style="border: solid #e1e1e1 1px;width: 100%;background: #f8f8f8;min-height: 50px;padding: 5px 2px;line-height: normal;border-radius: 0px;margin-bottom: 10px;font-size: 14px;color: #737373;">
                            <option value="Egypt" ${address.country=='Egypt' ? 'selected' : '' }>Egypt</option>
                            <option value="Saudi Arabia" ${address.country=='Saudi Arabia' ? 'selected' : '' }>Saudi
                              Arabia</option>
                        ...
                        <div class="field col-lg-3 col-md-3 col-sm-3 col-xs-3">
                          <input class="field_custom" placeholder="Building Number" type="number" name="building"
