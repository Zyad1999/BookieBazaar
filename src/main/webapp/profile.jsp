                        ...
                        <div class="row m-l-0 m-r-0">
                            ...
                            <div class="col-sm-12">
                                <div class="card-block">
                                    <h6 class="m-b-20 p-b-5 b-b-default f-w-600" style="font-size: 30px;">Information
                                    </h6>
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <h6 class="text-muted f-w-400">${requestScope.address.country},
                                                ${requestScope.address.city}, ${requestScope.address.street}, Building
                                                Number ${requestScope.address.buildingNumber}</h6>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <c:choose>
                                                <c:when test="${requestScope.admin or requestScope.admin eq true}">
                                                    <a class="btn sqaure_bt" id="jjjjj"
                                                        href="order_history?id=${param.id}">
                                                        Orders</a>
                                                </c:when>
                                                <c:otherwise>
