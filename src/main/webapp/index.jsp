                  ...
                  <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="0">
                    ...
                    <ol class="carousel-indicators">
                      ...
                      <c:forEach var="i" begin="0" end="${numIndicators - 1}" varStatus="loop">
                        <li data-target="#myCarousel" data-slide-to="${i}" class="${loop.first ? 'active' : ''}"></li>
                      </c:forEach>
                    </ol>
                    <!-- Wrapper for carousel items -->
                    <div class="carousel-inner">
                      <c:forEach var="category" items="${applicationScope.shopBooks.getCategories(1)}" varStatus="loop">
