          ...
          <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
            <ul>
              <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut"
                data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/book_images/b2.jpg"
                data-rotate="0" data-saveperformance="off" data-title="Computer Services" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/book_images/b2.jpg" alt="#" data-bgposition="center center" data-kenburns="on"
                ...
                <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" id="slide-18-layer-112"
                  ...
                  style="z-index: 6; white-space: nowrap;">Book Store</div>
                <!-- LAYER NR. 3 -->
              ...
              <li data-index="rs-181" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut"
                data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/book_images/b1.jpg"
                data-rotate="0" data-saveperformance="off" data-title="Easy To Use & Customize" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/book_images/b1.jpg" alt="" data-bgposition="center center" data-kenburns="on"
                  data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120"
                  data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0"
                  data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
              ...
              <li data-index="rs-18" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut"
                data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/book_images/Library-.jpeg"
                data-rotate="0" data-saveperformance="off" data-title="Perfectly Responsive" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/book_images/Library-.jpeg" alt="" data-bgposition="center center" data-kenburns="on"
                  data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120"
                  data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0"
                  data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Arts.jpg" width="200" height="200" class="img-fluid" alt="">
                        </div>
                    ...
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Children's Books.jpg" width="200" height="200" class="img-fluid"
                            alt="">
                        </div>
                        <div class="thumb-content">
                          <h4>Children's Books</h4>
                          <a href="#" class="btn btn-primary" style="min-width: 130px;">More <i
                              class="fa fa-angle-right"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Crime & Mystery.jpeg" width="200" height="200" class="img-fluid"
                            alt="">
                        </div>
                        <div class="thumb-content">
                          <h4>Crime & Mystery</h4>
                ...
                <div class="carousel-item">
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Education Studies.jpg" width="200" height="100" class="img-fluid"
                            alt="">
                        </div>
                        <div class="thumb-content">
                          <h4>Education Studies</h4>
                          </p>
                          <a href="#" class="btn btn-primary" style="min-width: 130px;">More <i
                              class="fa fa-angle-right"></i></a>
                        </div>
                    ...
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/History.jpg" width="200" height="200" class="img-fluid" alt="">
                        </div>
                        <div class="thumb-content">
                          <h4>History</h4>
                          <a href="#" class="btn btn-primary" style="min-width: 130px;">More <i
                    ...
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Humor & Entertainment.jpg" width="200" height="200"
                            class="img-fluid" alt="">
                        </div>
                        <div class="thumb-content">
                ...
                <div class="carousel-item">
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Law.jpg" width="200" height="200" class="img-fluid" alt="">
                        </div>
                        <div class="thumb-content">
                          <h4>Law</h4>
                          </p>
                    ...
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Romance.jpg" width="200" height="200" class="img-fluid" alt="">
                        </div>
                        <div class="thumb-content">
                          <h4>Romance</h4>
                          <a href="#" class="btn btn-primary" style="min-width: 130px;"> More <i
                    ...
                    <div class="col-sm-4">
                      <div class="thumb-wrapper">
                        <div class="img-box">
                          <img src="images/book_images/Fantasy.jpg" width="200" height="200" class="img-fluid" alt="">
                        </div>
                        <div class="thumb-content">
                          <h4>Fantasy</h4>
                          <a href="#" class="btn btn-primary" style="min-width: 130px;">More <i
